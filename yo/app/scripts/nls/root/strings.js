define({
    ...
    "SkipSetupPrompt": "Don't want to run through the configuration wizard? <a href=\"/console/index.html\">Click here</a> to start using Hobson immediately (the default password is \"local\").",
	"Start": "Start",
